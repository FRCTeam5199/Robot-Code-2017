...
public class Robot extends IterativeRobot {
	...
	public void autonomousInit() {
		SmartDashboard.putString("Autonmous Routine Selection", "autonNum");
		autoSthap=false;
	...
	public void teleopPeriodic() {
		...
		SmartDashboard.putNumber("Winch Current",pdp.getCurrent(0));
...
//		}
		...
		if(stick2.getRawButton(5)){ // Ball Box Program (02-13-16) - Kyle Watkins
